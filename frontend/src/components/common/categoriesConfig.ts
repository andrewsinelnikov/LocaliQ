    ...
    subcategories: [
      {
        ...
        items: [
          { name: 'Обробні дошки', imageUrl: '/images/products/woodcrafts/cutting-board.jpg', description: 'Натуральне дерево, покриття олією' },
          { name: 'Ложки', imageUrl: '/images/products/woodcrafts/wooden-spoons.jpg', description: 'Ручна різьба, з вільхи або бука' },
          { name: 'Миски та тарілки', imageUrl: '/images/products/woodcrafts/wooden-bowls.jpg', description: 'Точені вироби для кухні та сервірування' },
          { name: 'Табурети', imageUrl: '/images/products/woodcrafts/wooden-stool.jpg', description: 'Невеликі меблі з естетикою ручного виробництва' },
          { name: 'Свічники', imageUrl: '/images/products/woodcrafts/wooden-candle-holders.jpg', description: 'Декоративні та функціональні аксесуари для дому' },
          { name: 'Різьблені шкатулки', imageUrl: '/images/products/woodcrafts/wooden-boxes.jpg', description: 'Для зберігання прикрас і дрібниць' },
          { name: 'Полиці, органайзери', imageUrl: '/images/products/woodcrafts/wooden-shelves.jpg', description: 'Функціональний декор для дому' },
          { name: 'Іграшки', imageUrl: '/images/products/woodcrafts/wooden-toys.jpg', description: 'Екологічні іграшки для дітей' },
          { name: 'Кухонні набори', imageUrl: '/images/products/woodcrafts/wooden-kitchen-set.jpg', description: 'Лопатки, товкачі, качалки ручної роботи' },
          { name: 'Рамки', imageUrl: '/images/products/woodcrafts/wooden-frames.jpg', description: 'Натуральні рамки з унікальною текстурою' },
          { name: 'Малі меблі з масиву', imageUrl: '/images/products/woodcrafts/small-wooden-furniture.jpg', description: 'Лавки, приліжкові столики, тумби' },
          { name: 'Палиці для ходьби', imageUrl: '/images/products/woodcrafts/walking-sticks.jpg', description: 'Ергономічні, з декоративними елементами' },
        ]
      },
      {
