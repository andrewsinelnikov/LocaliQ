    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Узвар', imageUrl: '/images/products/kitchen/beverages/uzvar.jpg', description: 'Традиційний український різдвяний напій із сухофруктів' },
          ...
          { name: 'Молочний коктейль', imageUrl: '/images/products/kitchen/beverages/milkshake.jpg', description: 'Ванільний, шоколадний чи полуничний — класика' },
          { name: 'Латте з куркумою (Golden Milk)', imageUrl: '/images/products/kitchen/beverages/golden-milk.jpg', description: 'Тепле молоко з куркумою, імбиром і медом' },
          { name: 'Мʼятний джулеп безалкогольний', imageUrl: '/images/products/kitchen/beverages/virgin-mint-julep.jpg', description: 'Освіжаючий мʼятний напій з льодом' },
          ...
          { name: 'Марокканський мʼятний чай', imageUrl: '/images/products/kitchen/beverages/moroccan-mint-tea.jpg', description: 'Зелений чай з свіжою м’ятою та цукром' },
          ...
          { name: 'Сангрія безалкогольна', imageUrl: '/images/products/kitchen/beverages/virgin-sangria.jpg', description: 'Фруктовий пунш з виноградним соком і цитрусами' },
