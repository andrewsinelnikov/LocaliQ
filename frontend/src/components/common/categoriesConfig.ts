  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          { name: 'Квашена капуста', imageUrl: '/images/products/ferments-vinegars/sauerkraut.jpg', description: 'З ферментованої капусти без оцту' },
          { name: 'Огірки квашені', imageUrl: '/images/products/ferments-vinegars/pickles.jpg', description: 'З натуральним бродінням' },
          { name: 'Квашені помідори', imageUrl: '/images/products/ferments-vinegars/fermented-tomatoes.jpg', description: 'Соковиті домашні помідори, ферментовані у розсолі' },
          { name: 'Морква квашена з імбиром', imageUrl: '/images/products/ferments-vinegars/ginger-carrot.jpg', description: 'Хрустка морква з пряним імбирним відтінком' },
          { name: 'Яблучний оцет', imageUrl: '/images/products/ferments-vinegars/apple-vinegar.jpg', description: 'Домашній, нефільтрований оцет' },
          { name: 'Виноградний оцет', imageUrl: '/images/products/ferments-vinegars/grape-vinegar.jpg', description: 'Натуральний оцет з червоних виноградів, витриманий' },
          { name: 'Бальзамічний оцет', imageUrl: '/images/products/ferments-vinegars/balsamic-vinegar.jpg', description: 'Витриманий італійський оцет з винограду, солодкуватий і густий' },
          { name: 'Кімчі', imageUrl: '/images/products/ferments-vinegars/kimchi.jpg', description: 'Пряна корейська капуста — ферментована вдома' },
          { name: 'Комбуча', imageUrl: '/images/products/ferments-vinegars/kombucha.jpg', description: 'Ферментований чай з ніжним газуванням і корисними бактеріями' },

          { name: 'Місо паста', imageUrl: '/images/products/ferments-vinegars/miso.jpg', description: 'Японська ферментована паста з сої, для супів та маринадів' },
          { name: 'Темпе', imageUrl: '/images/products/ferments-vinegars/tempeh.jpg', description: 'Індонезійський продукт з ферментованої сої — білковий суперфуд' },
          { name: 'Натто', imageUrl: '/images/products/ferments-vinegars/natto.jpg', description: 'Традиційна японська ферментована соя з характерним ароматом' },
          { name: 'Кефір', imageUrl: '/images/products/ferments-vinegars/kefir.jpg', description: 'Ферментований молочний напій з пробіотиками' },
          { name: 'Йогурт домашній', imageUrl: '/images/products/ferments-vinegars/yogurt.jpg', description: 'Натуральний йогурт без добавок, з живими культурами' },
          { name: 'Сир із цвіллю', imageUrl: '/images/products/ferments-vinegars/blue-cheese.jpg', description: 'Європейський ферментований сир з благородною цвіллю' },
          { name: 'Соєвий соус', imageUrl: '/images/products/ferments-vinegars/soy-sauce.jpg', description: 'Традиційний ферментований соус з сої та пшениці' },
          { name: 'Сирний оцет (рибний соус)', imageUrl: '/images/products/ferments-vinegars/fish-sauce.jpg', description: 'Азійський соус з ферментованої риби — основа тайської кухні' },
          { name: 'Ферментований соєвий соус', imageUrl: '/images/products/ferments-vinegars/soy-sauce.jpg', description: 'Традиційний азійський соус із ферментованих соєвих бобів' },
          { name: 'Натто', imageUrl: '/images/products/ferments-vinegars/natto.jpg', description: 'Японські ферментовані соєві боби з унікальним смаком і текстурою' },
        ]
      },
      {
