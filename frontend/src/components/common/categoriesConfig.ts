...
export const categories: ICategory[] = [
  {
    ...
    subcategories: [
      ...
      { 
        ...
        items: [
          { name: 'Акацієвий мед', imageUrl:'/images/products/acacia-honey.jpg', description: 'Світлий, ніжний мед з акації, довго не кристалізується', season: 'травень-червень' },
          ...
          { name: 'Мед з прянощами', imageUrl: '/images/products/spiced-honey.jpg', description: 'Мед із додаванням кориці, імбиру, куркуми або чилі — для підтримки імунітету та тонусу', season: 'цілорічно' },
          { name: 'Мед з трав’яними екстрактами', imageUrl: '/images/products/herbal-honey.jpg', description: 'Мед, настояний на травах або оліях (шавлія, м’ята, евкаліпт) — для профілактики застуд і стресу', season: 'цілорічно' },
