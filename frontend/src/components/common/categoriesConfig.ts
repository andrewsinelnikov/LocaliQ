    ...
    subcategories: [
      ...
      { 
        ...
        items: [
          ...
          { name: 'Селера (листяна)', imageUrl: '/images/products/farm/greens-herbs/celery-leaf.jpg', description: 'Ароматне листя селери — для супів, салатів і смузі' },
          ...
          { name: 'Органо (материнка)', imageUrl: '/images/products/farm/greens-herbs/oregano.jpg', description: 'Ароматна спеція для піци та італійських страв' },
          { name: 'Фенхель (листя)', imageUrl: '/images/products/farm/greens-herbs/fennel-leaves.jpg', description: 'Ароматна зелень з анісовим присмаком' },
