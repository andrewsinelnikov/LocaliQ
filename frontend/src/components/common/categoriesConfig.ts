  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          { name: 'Сир бринза', imageUrl: '/images/products/kitchen/cheese-cured-meats/brynza.jpg', description: 'Солоний овечий сир' },
          ...
          { name: 'Сир сулугуні', imageUrl: '/images/products/kitchen/cheese-cured-meats/suluguni.jpg', description: 'Розсільний сир, м’який і злегка кислуватий' },
          ...
          { name: 'Сир фета домашній', imageUrl: '/images/products/kitchen/cheese-cured-meats/feta.jpg', description: 'Ніжний м’який сир у розсолі, на грецький манер' },
          { name: 'Сир камамбер', imageUrl: '/images/products/kitchen/cheese-cured-meats/camembert.jpg', description: 'М’який сир з пліснявою ручної роботи' },
          ...
          { name: 'Сир пармезан ', imageUrl: '/images/products/kitchen/cheese-cured-meats/parmesan.jpg', description: 'Витриманий твердий сир із горіховим смаком' },
          ...
          { name: 'Сир чеддер', imageUrl: '/images/products/kitchen/cheese-cured-meats/cheddar.jpg', description: 'Твердий сир із насиченим вершковим смаком' },
          ...
          { name: 'Сир дорблю', imageUrl: '/images/products/kitchen/cheese-cured-meats/blue-cheese.jpg', description: 'М’який сир із благородною блакитною пліснявою' },
          ...
          { name: 'Сир моцарела', imageUrl: '/images/products/kitchen/cheese-cured-meats/mozzarella.jpg', description: 'Свіжий м’який сир для салатів і піци' },
