    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Несесери та косметички', imageUrl: '/images/products/handmade/leather-goods/leather-toiletry-bag.jpg', description: 'Дорожні органайзери з натуральної шкіри' },
          ...
          { name: "Чохли для інструментів", imageUrl: "/images/products/handmade/leather-goods/leather-scissors-holder.jpg", description: "Шкіряні чохли для ножиць та професійних інструментів" },
          { name: "Ремінці для годинників", imageUrl: "/images/products/handmade/leather-goods/leather-watch-strap.jpg", description: "Преміальні ремінці для смарт- та класичних годинників" },
          { name: 'Футляри для окулярів', imageUrl: '/images/products/handmade/leather-goods/leather-glasses-case.jpg', description: 'Жорсткі та мʼякі шкіряні чохли для окулярів' },
          ...
          { name: "Підставки під кружки", imageUrl: "/images/products/handmade/leather-goods/leather-coaster.jpg", description: "Набори шкіряних підставок з тисненням" },
