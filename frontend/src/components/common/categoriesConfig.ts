...
export const categories: ICategory[] = [
  {
    ...
    subcategories: [
      ...
      { 
        ...
        items: [
          { name: 'Квіти в горщиках', imageUrl: '/images/products/farm/herbs-flowers/potted-flowers.jpg', description: 'Кімнатні та садові рослини' },
          { name: 'Букети на замовлення', imageUrl: '/images/products/farm/herbs-flowers/custom-bouquet.jpg', description: 'Індивідуальні композиції від фермерів' },
          { name: 'Троянди', imageUrl: '/images/products/farm/herbs-flowers/roses.jpg', description: 'Ароматні троянди з ферми' },
          { name: 'Лілії', imageUrl: '/images/products/farm/herbs-flowers/lilies.jpg', description: 'Ароматні великі квіти, ідеальні для урочистостей' },
          { name: 'Тюльпани', imageUrl: '/images/products/farm/herbs-flowers/tulips.jpg', description: 'Весняні тюльпани від місцевих виробників' },
          { name: 'Нарциси', imageUrl: '/images/products/farm/herbs-flowers/daffodils.jpg', description: 'Весняні квіти з фермерських клумб' },
          { name: 'Жоржини', imageUrl: '/images/products/farm/herbs-flowers/dahlias.jpg', description: 'Барвисті квіти для яскравих букетів' },
          { name: 'Гортензії', imageUrl: '/images/products/farm/herbs-flowers/hydrangeas.jpg', description: 'Обʼємні квіти у ніжних тонах' },
          { name: 'Айстри', imageUrl: '/images/products/farm/herbs-flowers/asters.jpg', description: 'Квітковий символ осені' },
          { name: 'Квіти польові', imageUrl: '/images/products/farm/herbs-flowers/wildflowers.jpg', description: 'Сезонні букети' },
          { name: 'Півонії сезонні', imageUrl: '/images/products/farm/herbs-flowers/peonies.jpg', description: 'Свіжі півонії в сезон' },
          { name: 'Ромашки', imageUrl: '/images/products/farm/herbs-flowers/daisies.jpg', description: 'Ніжні польові квіти' },
        ]
      },
    ],
  },
