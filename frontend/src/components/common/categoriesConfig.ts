    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Глиняні горщики для рослин', imageUrl: '/images/products/handmade/pottery-ceramics/plant-pot.jpg', description: 'Натуральні горщики для кімнатних рослин та саду' },
          { name: 'Молочники та вершники', imageUrl: '/images/products/handmade/pottery-ceramics/creamer.jpg', description: 'Керамічні молочники для сніданку та кави' },
          { name: 'Супниці', imageUrl: '/images/products/handmade/pottery-ceramics/soup-bowl.jpg', description: 'Глиняні супниці для щоденних та святкових обідів' },
          ...
          { name: 'Керамічні підставки під гаряче', imageUrl: '/images/products/handmade/pottery-ceramics/trivet.jpg', description: 'Стильні та практичні підставки для гарячого посуду' },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Брошки ручної роботи', imageUrl: '/images/products/handmade/jewelry/brooch.jpg', description: 'Авторські брошки для додаткового шарму образу' },
          ...
          { name: 'Кольє-браслет-комплект', imageUrl: '/images/products/handmade/jewelry/full-set.jpg', description: 'Повний комплект прикрас ручної роботи для святкових подій' },
          ...
          { name: 'Каблучки з дерев’яними вставками', imageUrl: '/images/products/handmade/jewelry/wood-inlay-ring.jpg', description: 'Теплі та унікальні каблучки з дерева та металу' },
          { name: 'Сережки у стилі бохо', imageUrl: '/images/products/handmade/jewelry/boho-earrings.jpg', description: 'Легкі, повітряні сережки у стилі бохо' },
          ...
          { name: 'Кольє з авторським дизайном', imageUrl: '/images/products/handmade/jewelry/designer-necklace.jpg', description: 'Унікальні кольє від майстра, створені вручну' },
          { name: 'Підвіски для ключів', imageUrl: '/images/products/handmade/jewelry/keychain-pendant.jpg', description: 'Мініатюрні прикраси для ключів або сумки' },
          { name: 'Сережки-гвіздки з бісеру', imageUrl: '/images/products/handmade/jewelry/beaded-stud-earrings.jpg', description: 'Яскраві сережки-гвіздки для повсякденного носіння' },
          { name: 'Каблучки з перлів', imageUrl: '/images/products/handmade/jewelry/pearl-ring.jpg', description: 'Ніжні каблучки з натуральних перлів для святкових образів' },
          { name: 'Сережки-каплі', imageUrl: '/images/products/handmade/jewelry/drop-earrings.jpg', description: 'Довгі сережки-каплі, що підкреслять елегантність' },
