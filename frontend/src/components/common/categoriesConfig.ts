    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Функціональний тренінг', imageUrl: '/images/products/functional-training.jpg', description: 'Тренування для покращення рухових навичок у повсякденному житті' },
          ...
          { name: 'Реабілітаційна гімнастика', imageUrl: '/images/products/rehab-exercise.jpg', description: 'Вправи для відновлення після травм або операцій' },
          { name: 'Гімнастика для спини', imageUrl: '/images/products/back-gym.jpg', description: 'Комплекси вправ для зміцнення та підтримки здоров’я хребта' },
          { name: 'Тренування з власною вагою', imageUrl: '/images/products/bodyweight-training.jpg', description: 'Сила та витривалість без додаткового обладнання' },
