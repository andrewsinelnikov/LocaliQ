  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          { name: 'Свічники', imageUrl: '/images/products/handmade/metalwork/candle-holder.jpg', description: 'Ковані свічники ручної роботи для інтерʼєру' },
          { name: 'Підсвічники та ліхтарі', imageUrl: '/images/products/handmade/metalwork/lantern.jpg', description: 'Декоративні металеві підсвічники та ліхтарі' },
          ...
          { name: 'Фурнітура', imageUrl: '/images/products/handmade/metalwork/metal-handle.jpg', description: 'Кована декоративна фурнітура для меблів та дверей' },
