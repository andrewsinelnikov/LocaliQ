  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          { name: 'Пілатес', imageUrl: '/images/products/wellness/movement-bodywork/pilates.jpg', description: 'Плавна робота з тілом для гнучкості та зміцнення м’язів' },
          { name: 'Функціонал', imageUrl: '/images/products/wellness/movement-bodywork/functional-training.jpg', description: 'Тренування для покращення рухових навичок у повсякденному житті' },
          { name: 'Розтяжка (стретчинг)', imageUrl: '/images/products/wellness/movement-bodywork/stretching.jpg', description: 'Заняття для розвитку гнучкості та зняття м’язової напруги' },
          { name: 'Реабілітація', imageUrl: '/images/products/wellness/movement-bodywork/rehab-exercise.jpg', description: 'Вправи для відновлення після травм або операцій' },
          { name: 'Заняття для осанки', imageUrl: '/images/products/wellness/movement-bodywork/posture-class.jpg', description: 'Покращення осанки та м’язового тонусу' },
          { name: 'Здорова спина', imageUrl: '/images/products/wellness/movement-bodywork/back-gym.jpg', description: 'Комплекси вправ для зміцнення та підтримки здоров’я хребта' },
          { name: 'З власною вагою', imageUrl: '/images/products/wellness/movement-bodywork/bodyweight-training.jpg', description: 'Сила та витривалість без додаткового обладнання' },
          { name: 'Балет', imageUrl: '/images/products/wellness/movement-bodywork/ballet.jpg', description: 'Грація, постава та сила через балетну техніку' },
          { name: 'Танцювальні заняття', imageUrl: '/images/products/wellness/movement-bodywork/dance-class.jpg', description: 'Розвивають гнучкість та координацію' },
          { name: 'Контемпорарі', imageUrl: '/images/products/wellness/movement-bodywork/contemporary-class.jpg', description: 'Сучасна техніка танцю з елементами імпровізації' },
          { name: 'Фітнес-танці', imageUrl: '/images/products/wellness/movement-bodywork/dance-fitness.jpg', description: 'Поєднання танцю і тренування в одному' },
          { name: 'Танці для дітей', imageUrl: '/images/products/wellness/movement-bodywork/kids-dance.jpg', description: 'Розвиток пластики, ритму та впевненості у русі' },
        ],
      },
      {
        ...
        items: [
          { name: 'Тренування 1-на-1', imageUrl: '/images/products/wellness/fitness-training/personal-training.jpg', description: 'Індивідуальні заняття з сертифікованим тренером' },
          { name: 'Групові заняття', imageUrl: '/images/products/wellness/fitness-training/group-fitness.jpg', description: 'Динамічні тренування в міні-групах' },
          { name: 'HIIT', imageUrl: '/images/products/wellness/fitness-training/hiit.jpg', description: 'Інтенсивні інтервальні вправи для спалювання жиру' },
          { name: 'Кросфіт', imageUrl: '/images/products/wellness/fitness-training/crossfit.jpg', description: 'Функціональні тренування високої інтенсивності' },
          { name: 'Кардіо тренування', imageUrl: '/images/products/wellness/fitness-training/cardio-training.jpg', description: 'Заняття для покращення серцево-судинної системи' },
          { name: 'Силові тренування', imageUrl: '/images/products/wellness/fitness-training/strength-training.jpg', description: 'Побудова м’язів та розвиток сили' },
          { name: 'TRX-тренування', imageUrl: '/images/products/wellness/fitness-training/trx-training.jpg', description: 'Тренування з використанням підвісних петель' },
          { name: 'Нордік-ходьба', imageUrl: '/images/products/wellness/fitness-training/nordic-walking.jpg', description: 'Аеробна активність з палицями для людей будь-якого віку' },
          { name: 'Аеробіка', imageUrl: '/images/products/wellness/fitness-training/aerobics.jpg', description: 'Енергійні тренування під музику для покращення витривалості' },
          { name: 'Для вагітних', imageUrl: '/images/products/wellness/fitness-training/prenatal-fitness.jpg', description: 'Безпечні вправи для майбутніх мам' },
          { name: 'Аквааеробіка', imageUrl: '/images/products/wellness/fitness-training/aqua-aerobics.jpg', description: 'Фітнес у воді для м’якого, але ефективного навантаження' },
          { name: 'Плавання', imageUrl: '/images/products/wellness/fitness-training/swimming.jpg', description: 'Тренування для всього тіла з низьким навантаженням на суглоби' },
        ],
      },
      {
        ...
        items: [
          { name: 'Поради нутриціолога', imageUrl: '/images/products/wellness/nutrition/nutrition-consultation.jpg', description: 'Індивідуальні рекомендації щодо харчування для здоров’я' },
          { name: 'Аналіз харчування', imageUrl: '/images/products/wellness/nutrition/nutrition-analysis.jpg', description: 'Оцінка раціону та рекомендації щодо покращення' },
          { name: 'Планування раціону', imageUrl: '/images/products/wellness/nutrition/meal-planning.jpg', description: 'Складання збалансованого меню на тиждень' },
          { name: 'Дієтичні програми', imageUrl: '/images/products/wellness/nutrition/diet-programs.jpg', description: 'Персональні дієти для контролю ваги та самопочуття' },
          { name: 'Здорові перекуси', imageUrl: '/images/products/wellness/nutrition/healthy-snacks.jpg', description: 'Рецепти та готові набори корисних закусок' },        
          { name: 'Майстер-класи', imageUrl: '/images/products/wellness/nutrition/cooking-classes.jpg', description: 'Навчання приготуванню здорової їжі' },
          { name: 'Суперфуди', imageUrl: '/images/products/wellness/nutrition/superfood.jpg', description: 'Корисні добавки до раціону' },
          { name: 'Меню для дітей', imageUrl: '/images/products/wellness/nutrition/kids-menu.jpg', description: 'Рекомендації по харчуванню для дітей різного віку' },
          { name: 'Веган-раціон', imageUrl: '/images/products/wellness/nutrition/vegan-meal-plan.jpg', description: 'Збалансоване меню без продуктів тваринного походження' },
          { name: 'Вегетаріанські меню', imageUrl: '/images/products/wellness/nutrition/vegetarian-menu.jpg', description: 'Збалансовані плани харчування без м’яса' },
          { name: 'Для спортсменів', imageUrl: '/images/products/wellness/nutrition/sports-nutrition.jpg', description: 'Оптимізоване харчування для підтримки фізичної активності' },          
          { name: 'При алергіях, діабеті', imageUrl: '/images/products/wellness/nutrition/allergy-meal-plan.jpg', description: 'Індивідуальні меню з урахуванням харчових обмежень' },
        ],
      },
      {
