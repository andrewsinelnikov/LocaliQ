    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Соус Тартар", imageUrl: "/imaes/products/kitchen/savory-spreads-sauces/tartar-sauce.jpg",description: "Кремовий соус з маринованими огірками, каперсами та зеленню" },
          ...
          { name: "Паста з копченої риби", imageUrl: "/images/products/kitchen/savory-spreads-sauces/smoked-fish-spread.jpg", description: "Намаз із копченої риби з вершковим сиром та зеленню" },
