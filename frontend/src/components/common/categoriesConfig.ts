    ...
    subcategories: [
      {
        ...
        items: [
          { name: 'Релакс масаж', imageUrl: '/images/products/wellness/relax-massage.jpg', description: 'Професійний масаж для зняття напруги' },
          { name: 'Сауна та ІЧ-терапія', imageUrl: '/images/products/wellness/infrared-sauna.jpg', description: "Очищення тіла та зниження м'язового напруження" },
          { name: 'Таласотерапія', imageUrl: '/images/products/wellness/thalasotherapy.jpg', description: 'Процедури з морськими мінералами для оздоровлення шкіри та тіла' },
          { name: 'СПА-процедури', imageUrl: '/images/products/wellness/spa-treatments.jpg', description: 'Комплексний догляд за тілом' },    
          { name: 'Фізіотерапія', imageUrl: '/images/products/wellness/physiotherapy.jpg', description: 'Відновлення після травм або хронічного болю' },
          { name: 'Чан на травах', imageUrl: '/images/products/wellness/herbal-hot-tub.jpg', description: 'Природне відновлення в гарячій воді з лікувальними травами' },
          { name: 'Апітерапія', imageUrl: '/images/products/wellness/apitherapy.jpg', description: 'Оздоровчі процедури з використанням продуктів бджільництва' },
          { name: 'Гідромасаж', imageUrl: '/images/products/wellness/hydro-massage.jpg', description: 'Водні процедури для глибокого розслаблення' },
          { name: 'Іпотерапія', imageUrl: '/images/products/wellness/hippotherapy.jpg', description: 'Терапія з конем для покращення емоційного та фізичного стану' },
          { name: 'Фасціальний реліз', imageUrl: '/images/products/wellness/myofascial-release.jpg', description: "Мануальна техніка для зменшення напруги в м'язах" },
          { name: 'Соляна кімната', imageUrl: '/images/products/wellness/salt-room.jpg', description: 'Інгаляції мінеральною сіллю для дихальної системи' },
          { name: 'Кріотерапія', imageUrl: '/images/products/wellness/cryotherapy.jpg', description: 'Охолоджувальні процедури для зменшення запалення' }
        ],
      },
      {
