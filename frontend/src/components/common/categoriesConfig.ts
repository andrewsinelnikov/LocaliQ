    ...
    subcategories: [
      ...
      { 
        ...
        items: [
          ...
          { name: 'Мед з травами', imageUrl: '/images/products/herbal-honey.jpg', description: 'Мед, настояний на травах або оліях (шавлія, м’ята, евкаліпт) — для профілактики застуд і стресу', season: 'цілорічно' },
