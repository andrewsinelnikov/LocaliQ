    ...
    subcategories: [
      {
        ...
        items: [
          { name: 'Деревʼяні лавки', imageUrl: '/images/products/handmade/woodcrafts/wooden-bench.jpg', description: 'Лавки з масиву для дому, тераси або передпокою' },
          ...
          { name: 'Деревʼяні тумби', imageUrl: '/images/products/handmade/woodcrafts/wooden-cabinet.jpg', description: 'Функціональні тумби для зберігання речей' },
