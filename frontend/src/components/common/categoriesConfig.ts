...
export const categories: ICategory[] = [
  {
    ...
    subcategories: [
      { 
        ...
        items: [
          { name: 'Морква', imageUrl: '/images/products/farm/carrot.jpg', description: 'Молода морква з органічного городу', season: 'весна-осінь' },
          { name: 'Капуста', imageUrl: '/images/products/farm/cabbage.jpg', description: 'Білокачанна капуста для салатів і квашення', season: 'літо-осінь' },
          { name: 'Помідори рожеві', imageUrl: '/images/products/farm/tomato.jpg', description: 'Солодкі помідори домашнього сорту', season: 'літо' },
          { name: 'Огірки', imageUrl: '/images/products/farm/cucumber.jpg', description: 'Хрумкі огірки для салатів та маринування', season: 'літо' },
          { name: 'Цибуля', imageUrl: '/images/products/farm/onion.jpg', description: 'Ароматна ріпчаста цибуля', season: 'літо-осінь' },
          { name: 'Буряк', imageUrl: '/images/products/farm/beetroot.jpg', description: 'Соковитий буряк для борщу та салатів', season: 'все літо' },
          { name: 'Редиска', imageUrl: '/images/products/farm/radish.jpg', description: 'Соковита весняна редиска, чудова для салатів', season: 'весна' },
          { name: 'Цвітна капуста', imageUrl: '/images/products/farm/cauliflower.jpg', description: 'Ніжна цвітна капуста, багата вітамінами', season: 'літо-осінь' },
          { name: 'Паприка', imageUrl: '/images/products/farm/paprika.jpg', description: 'Солодка паприка яскравого кольору', season: 'літо' },
          { name: 'Зелений горошок', imageUrl: '/images/products/farm/peas.jpg', description: 'Свіжозібраний зелений горошок', season: 'весна-початок літа' },
          { name: 'Червоний перець', imageUrl: '/images/products/farm/red-pepper.jpg', description: 'Соковитий солодкий перець', season: 'літо' },
          { name: 'Кукурудза', imageUrl: '/images/products/farm/corn.jpg', description: 'Солодка кукурудза, ідеальна для варіння та грилю', season: 'літо' },
          { name: 'Картопля', imageUrl: '/images/products/farm/potato.jpg', description: 'Домашня картопля, універсальна для приготування', season: 'літо-осінь' },
          { name: 'Листя салату', imageUrl: '/images/products/farm/lettuce.jpg', description: 'Свіже зелене листя для салатів', season: 'весна-літо' },
          { name: 'Спаржа', imageUrl: '/images/products/farm/asparagus.jpg', description: 'Соковита зелена спаржа — делікатес весни', season: 'весна' }
        ]
      },
      { 
